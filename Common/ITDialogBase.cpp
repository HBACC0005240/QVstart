#include "ITDialogBase.h"
#include <QSpacerItem>
#include <QApplication>

ITDialogBase::ITDialogBase(QWidget *parent)
	: QDialog(parent)
{
...
ITDialogBase::~ITDialogBase()
{

}

void ITDialogBase::mousePressEvent(QMouseEvent* e)
{
...
void ITDialogBase::mouseMoveEvent(QMouseEvent* e)
{
...
void ITDialogBase::mouseReleaseEvent(QMouseEvent* e)
{
	m_isMove = false;
...
//屏蔽ESC退出
void ITDialogBase::keyPressEvent(QKeyEvent * e)
{
	switch (e->key())
	{
	case Qt::Key_Escape:
...
void ITDialogBase::region(const QPoint &cursorGlobalPoint)
{
...
void ITDialogBase::setMoveEanable(bool isMove /*= true*/)
{
	m_isMoveAble = isMove;
}

void ITDialogBase::leaveEvent(QEvent *)
{
	m_dir = NONE;
	QApplication::setOverrideCursor(Qt::ArrowCursor);
}

void ITDialogBase::initTitle()
{
